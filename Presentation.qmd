...
# Modeling Differences (cut off??)

Modeling can be broken down in a generic set of steps that vary when the focus changes from explanation to predicion
...
- **Sample Size**:
  - Explanatory: Adequate precision for inference, statistical power
  - Predictive: Larger sample for lower bias/variance, holdout datasets
...
- **Experimental vs. Observational**:
  - Explanatory: Prefer experimental data
  - Predictive: Observational data may be better for realistic context
...
- **Numerical Summaries**:
  - Explanatory: Focus on theoretical relationships
  - Predictive: Wide range of summaries for all variables
...
- **Explanatory Modeling**:
  ...
  - Examples: antecedent, consequent, mediator, moderator, treatment, control, exposure, confounding
...
- **Bias-Variance Trade-off**:
  - Shrinkage methods (e.g., ridge regression) reduce variance
